...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('component/font-awesome/css/font-awesome.min.css')}}">
		...
		padding-top: 70px;
		padding-bottom: 70px;
		background-image: url({{asset('gambar/lab11.jpg')}});;
		}
	.starter-template {
		padding: 40px 15px;
		text-align: center;
...
<body>
		...
		<a class="navbar-brand" href="{{url('/')}}"> SISTEM INFORMASI BINA OLAHRAGA BUSAM </a>		
				</div>
		...
		<a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Pengguna <span class="caret"></span></a>	
			...
			<li><a href="{{url('useratlet')}}"> Data Atlet</a></li></ul>
		...
		<a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Data Olahraga <span class="caret"></span></a>	
			<ul class="dropdown-menu" aria-labelledby="dLabel">
			<li><a href="{{url('userpelatih_olahraga')}}"> Data Pelatih Olahraga</a></li>
			<li><a href="{{url('userjadwal_olahraga')}}"> Data Jadwal Olahraga</a></li>
			</ul>	
				</li>
				<li class="dropdown active">
