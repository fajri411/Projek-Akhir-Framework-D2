...
<div class="form-group">
	<label class="col-sm-2 control-label" id="nama_pelatih">Nama Pelatih</label>
	<div class="col-sm-10">
		{!! Form::text('nama_pelatih',null,['class'=>'form-control','id'=>'nama_pelatih','placeholder'=>"Nama Pelatih"]) !!}
	</div>	
</div>
<div class="form-group">
