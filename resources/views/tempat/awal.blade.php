								...
								@foreach ($data as $tempat)
									...
									<td>
										<div class="btn-group" role-"group">
											<a href="{{url('tempat/edit/'.$tempat->id)}}" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="top" title="Ubah">
											<i class="fa fa-pencil"></i></a>
											<a href="{{url('tempat/'.$tempat->id)}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Lihat"><i class="fa fa-eye"></i></a>
